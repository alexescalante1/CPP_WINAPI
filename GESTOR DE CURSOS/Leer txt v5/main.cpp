...
void CONCATENAR(string CAD,bool B){
    int i = 0;
    if(B){
        for(;ENTRADA_C[i];i++);
        ENTRADA_C[i]=CAD[0];
...
void CADENA_ENDL(string C,int EXPONENCIAL){
    PALABRA(&C[0],0,EXPONENCIAL);
    for(int p=0,h=0;C[p];p++,h++){
        if(C[p]==' '){
            if(!PALABRA(&C[p],h,EXPONENCIAL)){
...
void ESPACIOS_ENCRIP(int T,bool X,ofstream *SALIDA_HTML){
    for(int i=0;i<NUMFILAS;i++){
        *SALIDA_HTML<<PARRAFO[i]<<"</p><br><p>";
    }
}
...
void HTML(ofstream *SALIDA_HTML){
    ...
    *SALIDA_HTML<<" contenido = contenido.replace(/:::/gi, "<<(char)34<<"<main><h4>"<<(char)34<<"); contenido = contenido.replace(/@@@/gi, "<<(char)34<<"<main><div><div><samp>"<<(char)34<<"); contenido = contenido.replace(/<a><b>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<c><d>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<d><e>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<e><f>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<f><g>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<g><h>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<h><i>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<i><j>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<j><k>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<k><l>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<l><m>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<m><n>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<n><o>/gi, "<<(char)34<<""<<(char)34<<"); contenido = contenido.replace(/<o><p>/gi, "<<(char)34<<""<<(char)34<<");  contenido = contenido.replace(/<p>&&&/gi, "<<(char)34<<"</div></div></main>"<<(char)34<<"); contenido = contenido.replace(/<a>/gi, "<<(char)34<<"</h4><p>"<<(char)34<<"); contenido = contenido.replace(/<b>/gi, "<<(char)34<<"</p><h2>"<<(char)34<<"); contenido = contenido.replace(/<c>/gi, "<<(char)34<<"</samp><h2>Trabajo</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<d>/gi, "<<(char)34<<"</p><h2>Tipo</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<e>/gi, "<<(char)34<<"</p><h2>Detalle</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<f>/gi, "<<(char)34<<"</p><h2>Referencia</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<g>/gi, "<<(char)34<<"</p><h2>Fecha Inicio</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<h>/gi, "<<(char)34<<"</p><h2>Fecha limite</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<i>/gi, "<<(char)34<<"</p><h2>Hora limite</h2><p>"<<(char)34<<"); contenido = contenido.replace(/<j>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/<k>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/<l>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/<m>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/<n>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/<o>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/<p>/gi, "<<(char)34<<"</p><h2></h2><p>"<<(char)34<<"); contenido = contenido.replace(/&&&/gi, "<<(char)34<<"</div></div></main>"<<(char)34<<"); contenido = contenido.replace(/%%%/gi, "<<(char)34<<"</h2></main>"<<(char)34<<"); mostrarContenido(contenido);  } function mostrarContenido(contenido) { var elemento = document.getElementById('contenido-archivo'); elemento.innerHTML = contenido; } document.getElementById('file-input'); document.addEventListener('change', leerArchivo, false);  </script>  <style> *{ margin: 0; padding: 0; box-sizing: border-box; } body{ font-family: 'open sans';  } @media screen and (max-width: 8200px){ main{ padding: 10px; width: 100%; max-width: 600px; margin: auto; overflow: hidden; font-family: 'open sans'; } p{ color: rgb(211, 40, 40); font-size: 20px; text-align: center; margin-bottom: 60px; margin-top: -60px; }  h2{ color: #642a73; font-size: 20px; text-align: center; margin-bottom: 60px; }  } @media screen and (max-width: 800px){ main{ padding: 10px; width: 100%; max-width: 800px; margin: auto; overflow: hidden; font-family: 'open sans'; } h4{  font-size: 20px;  } p{ color: rgb(211, 40, 40); font-size: 13px; text-align: center; margin-bottom: 60px; margin-top: -60px; }  h2{ color: #642a73; font-size: 20px; text-align: center; margin-bottom: 60px; }  } @media screen and (max-width: 600px){ main{ padding: 10px; width: 100%; max-width: 1100px; margin: auto; overflow: hidden; font-family: 'open sans'; } h4{  font-size: 17px;  } p{ color: rgb(211, 40, 40); font-size: 13px; text-align: center; margin-bottom: 60px; margin-top: -60px; }  h2{ color: #642a73; font-size: 17px; text-align: center; margin-bottom: 60px; }  } header{ width: 100%; height: 900px; background: #40E0D0;  background: -webkit-linear-gradient(to right, rgba(255, 0, 128, 0.459), rgba(255, 140, 0, 0.596), rgba(64, 224, 208, 0.555)),url(Portada.jpg); background: linear-gradient(to right, rgba(255, 0, 128, 0.459), rgba(255, 140, 0, 0.596), rgba(64, 224, 208, 0.555)),url(Portada.jpg); background-size: cover; background-attachment: fixed; position: relative; } header .textos-header{ display: flex; height: 700px; width: 100%; align-items: center; justify-content: center; flex-direction: column; text-align: center; } .textos-header h1{ font-size: 50px; color: white; } .wave{ position: absolute; bottom: 0; width: 100%; } .cuentas{ display: flex; justify-content: space-evenly; } div{ width: 100%; align-items: center; justify-content: center; flex-direction: column; text-align: center; } samp{ background: #642a73; color: #ffffff; font-size: 50px; margin-bottom: 10px; border-radius: 50%; display: inline-block; text-align: center; width: 40px; height: 40px; box-shadow: 0 0 6px 0 rgba(0, 0, 0, 0.5); } main > h4{ background: #4d0686; display: flex; justify-content: space-evenly; height: 100px; margin-bottom: 55px; align-items: center; border-radius: 5px; font-size: 30px; color: #ffffff; box-shadow: 0 0 6px rgba(0, 0, 0, 0.6); } main > p{ background: #3b0766; display: flex; justify-content: space-evenly; height: 30px; align-items: center; border-radius: 5px; font-size: 20px; color: #ffffff; box-shadow: 0 0 6px rgba(0, 0, 0, 0.6); } main > h2{ background: #000000ea; display: flex; justify-content: space-evenly; height: 20px; margin-top: -65px; margin-bottom: 20px; align-items: center; border-radius: 5px; font-size: 15px; color: #ffffff; box-shadow: 0 0 6px rgba(0, 0, 0, 0.6);  }  a{  border: none; color: white; text-decoration: none; position: relative;  display: flex;  margin-top: -130px; padding-top: 155px;  padding-left: 100%; border-radius: 5px; text-transform: uppercase; overflow: hidden; transition: 2s all ease; } a::before{ background: #000000; content: "<<(char)34<<""<<(char)34<<"; position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); z-index: -1; transition: all 0.6s ease;width: 100%; height: 0%; transform: translate(-50%,-50%) rotate(45deg); }  a:hover::before{ height: 380%; }  footer{ background: rgb(0, 0, 0); margin-top: 100px; padding: 20px 0 30px 0; overflow: hidden; color: white; font-size: 10px; text-align: center; } input[type="<<(char)34<<"file"<<(char)34<<"]{ display: none; } label{ color: white; height: 60px; width: 250px;  position: absolute; margin: auto; top: 0; bottom: 0; left: 0; right: 0; font-size: 20px; display: flex; justify-content: center; align-items: center; position: relative;  margin: 30px 0; border: 2px solid #ffffff;  text-transform: uppercase; overflow: hidden; transition: 2s all ease;  } label::after{ background: #ff7675; content: "<<(char)34<<""<<(char)34<<"; position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); z-index: -1; transition: all 0.6s ease; } label::after{ width: 100%; height: 0%; transform: translate(-50%,-50%) rotate(-45deg); } label:hover::after{ height: 380%; } </style> <link href="<<(char)34<<"https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@1,700&display=swap"<<(char)34<<" rel="<<(char)34<<"stylesheet"<<(char)34<<"></head><body> <header>  <section class="<<(char)34<<"textos-header"<<(char)34<<"> <h1>Mis Cuentas:</h1> <input class="<<(char)34<<"style"<<(char)34<<" type="<<(char)34<<"file"<<(char)34<<" id="<<(char)34<<"file-input"<<(char)34<<" /> <label for="<<(char)34<<"file-input"<<(char)34<<"> Seleccionar archivo </label>  </section> <div class="<<(char)34<<"wave"<<(char)34<<" style="<<(char)34<<"height: 150px; overflow: hidden;"<<(char)34<<" > <svg viewBox="<<(char)34<<"0 0 500 150"<<(char)34<<" preserveAspectRatio="<<(char)34<<"none"<<(char)34<<" style="<<(char)34<<"height: 100%; width: 100%;"<<(char)34<<"> <path d="<<(char)34<<"M0.00,49.98 C281.31,190.95 373.87,-45.88 500.00,49.98 L500.00,150.00 L0.00,150.00 Z"<<(char)34<<" style="<<(char)34<<"stroke: none; fill: #ffff;"<<(char)34<<"> </path> </svg> </div> </header> <div>  <pre id="<<(char)34<<"contenido-archivo"<<(char)34<<"></pre> </div> <footer> <p class="<<(char)34<<"titulo-final"<<(char)34<<">&copi My Counts @AlexEscalanteONE</p> </footer></body></html>";
}

void FECHAL(string Fecha,string Hora){
    time_t now = time(0);
    tm * time= localtime(&now);
    int ANIO = 1900+time->tm_year;
    int FECH[3];
    ...
    for(int i = 0,j=0;j<3;i++){
        if(Fecha[i]=='/'||Fecha[i]=='\0'){

            FECH[j] = atoi(AUX_CAD);
            AUX_CAD[0]='\0';j++;
        }else{
            CONCATENAR(&Fecha[i],0);
        }
    }
    for(int i = 0,j=0;j<3;i++){
        if(Hora[i]==':'||Hora[i]==' '){
    ...
    if(ANIO<=FECH[2]){
        if(time->tm_mon+1<=FECH[1]){
           if(FECH[0]>time->tm_mday){
                cout<<"\n              ESTAS A TIEMPO";
                HRA[2]=HRA[2]-time->tm_sec;
                if(HRA[2]<0){
                    HRA[1]-=1;
                    HRA[2]=HRA[2]+60;
                }
                HRA[1]=HRA[1]-time->tm_min;
                if(HRA[1]<0){
                    HRA[0]-=1;
                    HRA[1]=HRA[1]+60;
                }
                HRA[0]=HRA[0]-time->tm_hour;
                ...
                FECH[0]=FECH[0]-time->tm_mday;///

                if(FECH[0]<-time->tm_mday){ // dias negativos

                    for(int i=2020;i<=ANIO;i+=4){//bISIESTO
                        MESES[1]=29;
                    }

                    FECH[1]-=1; // mes -1
                    FECH[0]=MESES[FECH[1]-2]+FECH[0];
                }

                FECH[1]=FECH[1]-(time->tm_mon+1);

                FECH[2]=FECH[2]-ANIO;

                cout<<", Quedan "<<FECH[0]<<" Dias/ "<<FECH[1]<<" Mes/ "<<FECH[2]<<" Anios, Con ";
                cout<<HRA[0]<<":"<<HRA[1]<<":"<<HRA[2]<<" Segundos\n\n";

           }else if(FECH[0]==time->tm_mday){
                cout<<"\n              ES HOY";
                ...
                if(HRA[0]>=0){
                    cout<<", FALTA:  "<<HRA[0]<<":"<<HRA[1]<<":"<<HRA[2]<<" Segundos\n\n";
                }else{
                    cout<<", YA TERMINO EL TIEMPO! \n";
                }
...
class LISTA_CUENTAS{
    ...
    void MOS(NODO_DAT_CUENTA *R,bool V){
         ...
         while(R!=NULL){
            if(V){
                cout<<"     - Trabajo "<<R->ORDEN_CUENTA<<":\n\n";
                if(R->USER[0]!='\0'){

                    cout<<"          Nombre De Trabajo:     "<<R->USER<<"\n";
                }
                if(R->PASSWORD[0]!='\0'){

                    cout<<"          Tipo:                  "<<R->PASSWORD<<"\n";
                }
                if(R->CORREO[0]!='\0'){
                    CADENA_ENDL(R->CORREO,50);
                    cout<<"          Detalles:              \n";
                    ESPACIOS(50);NUMFILAS=0;
                    cout<<"\n";
                }
                if(R->CORREO_USER_VERIFICACION[0]!='\0'){

                    cout<<"          Libros Referidos:      "<<R->CORREO_USER_VERIFICACION<<"\n";
                }
                if(R->CORREO_PASSWORD_VERIFICACION[0]!='\0'){
                    cout<<"          Fecha Inicio:          "<<R->CORREO_PASSWORD_VERIFICACION<<"\n";
                }
                if(R->DOC_IDENTIDAD[0]!='\0'){
                    cout<<"          Fecha Limite:          "<<R->DOC_IDENTIDAD<<"\n";
                }
                if(R->TELEFONO1[0]!='\0'){
                    cout<<"          Hora Limite:           "<<R->TELEFONO1<<"\n";
                }

                FECHAL(R->DOC_IDENTIDAD,R->TELEFONO1);
...
class LISTA_APPS{
    ...
    void ENCRPDATS(NODO_APP *R){
         ...
         ofstream SALIDA_ENCRIPTADA("MY_WORKS.axel");
         ofstream SALIDA_LECTOR_HTML("MY LECTOR WORKS.html");
    ...
    void MOS(NODO_APP *R,bool V){
         ...
         while(R!=NULL){
            if(V){
                cout<<" NOMBRE DE CURSO:   "<<R->NOMBRE_APP
                    <<"\n    DOCENTE      :  "<<R->LINK_APP
                    <<"\n    GRUPO        :  "<<R->DESCRIPCION_APP<<"\n\n";
            }else{
...
bool LEER_DATOS(){
    ...
    ifstream MY_ENCRIPTT ("MY_WORKS.axel");
...
BOOL CALLBACK DlgH(HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    switch(uMsg)
    {
    case WM_PAINT:
...
//                system("date");
        ...
        {   switch(LOWORD(wParam))
            {
                char C1[500],C2[500],C3[2000],C4[500],C5[500],C6[500],C7[500],C8[500],
                     C9[500];
                int  N1;
                ...
                case G_BTN_PRINTF_CMD_1:
                    ...
                    return TRUE;
                case HORARIO_BTN:
                    EndDialog(hwndDlg, 0);HDCRECTANGLE=8;
                    DialogBox(hInst, MAKEINTRESOURCE(HORARIO_DG), NULL, (DLGPROC)DlgH);
                    return TRUE;
                case AP_BTN_C:
                ...
                case AP_BTN_M:
                    ...
                    GetDlgItemText(hwndDlg,AP_EDIT_C3,C4,2000);
                ...
                case CNT_BTN_C:
                    ...
                    GetDlgItemText(hwndDlg,CNT_EDIT_C4,C4,2000);
                    ...
                    if(V_CHAR(C1)&&V_CHAR(C2)&&V_CHAR(C3)&&V_CHAR(C4)&&V_CHAR(C5)&&V_CHAR(C6)&&V_CHAR(C7)&&V_CHAR(C8)){///COMPROBAR CARACTERES

                        if(C1[0]!='\0'&&C2[0]!='\0'&&C3[0]!='\0'){ ///CAMPOS REQUERIDOS

                            if(A.BUSCARYMODIFICAR_VALOR(1,C1,C2,C3,C4,C5,C6,C7,C8,"","","","","","","")){///RETORNA VALIDACION
                                A.ENCRIPTAR_DATS();
                                SetDlgItemText(hwndDlg,G_EDIT_ESTADO,"Los datos se ingresaron correctamente");
                ...
                case CNT_BTN_M:
                    ...
                    if(V_CHAR(C1)&&V_CHAR(C3)&&V_CHAR(C4)&&V_CHAR(C5)&&V_CHAR(C6)&&V_CHAR(C7)&&V_CHAR(C8)&&V_CHAR(C9)){///COMPROBAR CARACTERES

                        if(C1[0]!='\0'&&C3[0]!='\0'&&C4[0]!='\0'){ ///CAMPOS REQUERIDOS

                            if(A.MODIFICAR_DATOS_CUENTA_SEC(C1,0,N1,C3,C4,C5,C6,C7,C8,C9,"","","","","","","")){///RETORNA VALIDACION
                                A.ENCRIPTAR_DATS();
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
    hInst=hInstance;
    InitCommonControls();
    return DialogBox(hInst, MAKEINTRESOURCE(MYMENU), NULL, (DLGPROC)DlgMain);
}
